package com.portfolio.smercado.Security.Controller;

import com.portfolio.smercado.Security.Dto.JwtDto;
import com.portfolio.smercado.Security.Dto.LoginUsuario;
import com.portfolio.smercado.Security.Dto.NuevoUsuario;
...
import com.portfolio.smercado.Security.Jwt.JwtProvider;
import com.portfolio.smercado.Security.Service.RolService;
import com.portfolio.smercado.Security.Service.UsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<JwtDto> login(@Valid @RequestBody LoginUsuario loginUsuario, BindingResult bindingResult){
        if (bindingResult.hasErrors())
            return new ResponseEntity(new Mensaje("Campos con valores incorrectos"), HttpStatus.BAD_REQUEST);
